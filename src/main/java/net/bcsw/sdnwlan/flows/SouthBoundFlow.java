...
/**
 * Provides common interface for Southbound Flow implementations
 */
public abstract class SouthBoundFlow extends Flow {

    protected Object match = null;

    public SouthBoundFlow(ApplicationId appId,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            return true;
        } else if (obj != null && obj instanceof SouthBoundFlow) {
            SouthBoundFlow other = (SouthBoundFlow) obj;
